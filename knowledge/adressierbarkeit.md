...
Eine Notation ist adressierbar, wenn eine Stelle des Zeichens einer Stelle der
Sache entspricht — wenn man **hineinzeigen** kann. Das ist, soweit ich es bisher
sehe, die Eigenschaft, an der hängt, ob man in einer Notation entwerfen kann oder
nur ausführen. Sie ist unabhängig davon, ob die Notation eine Handlung oder ein
Ergebnis notiert.

## Kern

Der Begriff stand schon in [[handlungs-vs-ergebnis-notation]], aber als
*Erklärung* für die dortige Achse. Am 2026-08-21 hat sich gezeigt, dass er die
Achse nicht erklärt, sondern ersetzt.

| Notation | notiert | adressierbar? | wird darin entworfen? |
|---|---|---|---|
| Strickprosa 1655 / Kürzel `k2tog` | Handlung | **nein** (Fließtext) | nein |
...
waagerecht. Man kann eine Stimme mit dem Finger verfolgen, sehen, ob im Bass
etwas passiert, während oben die Melodie läuft, eine Passage überblicken, ohne
sie zu spielen. Die Strickprosa konnte das nicht — nicht weil sie Handlungen
notierte, sondern weil sie **ein Satz** war. Ein Fließtext hat keine Koordinaten.
Ein Griffbrett hat welche, und die Tabulatur borgt sie sich.
...
- **Vermutet:** dass Adressierbarkeit der *entscheidende* Faktor ist und nicht
  einer von mehreren. Übung, Status und Erlaubnis sind nicht kontrolliert. Weiss
